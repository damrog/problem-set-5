...
function reportCard() {
  ...
  let testScore;
   ...
   testScore = prompt("Input an integer between 1 and 100 for your testscore. Continue this process until all of your scores are inputted. Once all scores are inputted enter -1. ");
  while (testScore) {
